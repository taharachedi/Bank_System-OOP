...
private:
    ...
    static void _PrintTransferLogRecordLine(clsClient::stTransferLogRecord TransferLogRecord)
    {
...
public:
    ...
    static void ShowTransferLogScreen()
    {
        ...
        vector <clsClient::stTransferLogRecord> vTransferLogRecord = clsClient::Get_TransferLogList(); 
